    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <div class="dashboard-grid">
                ...
                <div class="chart-container grid-c-1-4 grid-r-1-3">
                    <canvas id="revenueChart"></canvas>
                </div>

                <!-- Top Right: Ratio Doughnut Chart (2x2) -->
                <div class="chart-container grid-c-4-6 grid-r-1-3">
                    <canvas id="ratioChart"></canvas>
                </div>

                <!-- Bottom Left: 4 Tiles (2x2) -->
                <div class="btn-grid grid-c-1-3 grid-r-3-5">
                    <div class="dashboard-card card-blue" onclick="loadModule('phong', 'Phòng')">
                        <div class="dashboard-card-title">Phòng trống</div>
                        <div class="dashboard-card-desc">${countPhongTrong}</div>
                    </div>
                    <div class="dashboard-card card-red" onclick="loadModule('phong', 'Phòng')">
                        <div class="dashboard-card-title">Đang sử dụng</div>
                        <div class="dashboard-card-desc">${countPhongDangSuDung}</div>
                    </div>
                    <div class="dashboard-card card-green" onclick="loadModule('nhan-vien', 'Nhân viên')">
                        <div class="dashboard-card-title">Nhân viên</div>
                        <div class="dashboard-card-desc">${countNhanVien}</div>
                    </div>
                    <div class="dashboard-card card-green" onclick="loadModule('khach-hang', 'Khách hàng')">
                        ...
                        <div class="dashboard-card-desc">${countKhachHang}</div>
                    </div>
                </div>

                <!-- Bottom Right: Booking Bar Chart (2x3) -->
                <div class="chart-container grid-c-3-6 grid-r-3-5">
                    <canvas id="bookingChart"></canvas>
                </div>
            </div>

            <!-- Hidden data containers to avoid JS linting errors and quote collisions -->
                <div id="data-store" class="d-none">

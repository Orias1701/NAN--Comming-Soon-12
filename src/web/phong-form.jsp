        ...
        <form id="frmPhong" action="phong-data" method="post">
            ...
            <div class="modal-form-grid">
                <div class="form-group full-width">
                    <label>ID:</label>
                    <input type="text" id="maPhong" name="maPhong" class="rounded-input" readonly style="background-color: #f0f0f0;" placeholder="Tự động tạo">
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn-swing btn-secondary" onclick="closeModal('modalPhong')">Hủy</button>
            </div>
        </form>
    </div>
</div>
